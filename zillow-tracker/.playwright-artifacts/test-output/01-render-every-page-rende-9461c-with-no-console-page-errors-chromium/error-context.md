...
- Name: 01-render.spec.ts >> every page renders cleanly >> /open-houses renders with no console/page errors
- Location: tests/e2e/01-render.spec.ts:17:5

# Error details

```
Error: /open-houses HTTP status
...
- generic [ref=e3]:
  ...
  - paragraph [ref=e5]: "Digest: 1334740556"
```
