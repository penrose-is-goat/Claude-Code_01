...
- Name: 02-filters.spec.ts >> checkbox filters round-trip (open house, favorites)
- Location: tests/e2e/02-filters.spec.ts:77:1
...
```
Error: page.check: Test timeout of 60000ms exceeded.
Call log:
  - waiting for locator('input[name="openHouse"]')
