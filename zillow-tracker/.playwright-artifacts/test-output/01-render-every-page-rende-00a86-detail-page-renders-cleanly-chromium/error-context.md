...
- Name: 01-render.spec.ts >> every page renders cleanly >> /listings/[id] detail page renders cleanly
- Location: tests/e2e/01-render.spec.ts:37:3
...
Call log:
  - waiting for locator('tbody tr a[href^="/listings/"]').first()
