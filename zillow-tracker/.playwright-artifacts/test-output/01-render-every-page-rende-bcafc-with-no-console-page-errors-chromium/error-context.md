...
- Name: 01-render.spec.ts >> every page renders cleanly >> / renders with no console/page errors
...
- banner:
  - navigation:
    ...
    - link "Settings":
      - /url: /settings
- main: "Database not ready Run `npm run db:push && npm run seed` to create and populate the database."
- alert
```
