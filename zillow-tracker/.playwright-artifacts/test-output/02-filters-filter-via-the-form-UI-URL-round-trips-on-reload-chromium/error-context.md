...
- Name: 02-filters.spec.ts >> filter via the form UI, URL round-trips on reload
- Location: tests/e2e/02-filters.spec.ts:55:1
...
Call log:
  - waiting for locator('input[name="minPrice"]')
