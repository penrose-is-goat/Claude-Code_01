...
- Name: 02-filters.spec.ts >> sort round-trips and actually reorders
- Location: tests/e2e/02-filters.spec.ts:88:1
...
```yaml
- generic [ref=f1e3]:
  - 'heading "Application error: a server-side exception has occurred while loading localhost (see the server logs for more information)." [level=2] [ref=f1e4]'
  - paragraph [ref=f1e5]: "Digest: 437234774"
```
