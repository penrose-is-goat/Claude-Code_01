...
- Name: 04-notes.spec.ts >> notes editor >> rating can be cleared back to none
- Location: tests/e2e/04-notes.spec.ts:76:3
...
Call log:
  - waiting for locator('tbody tr a[href^="/listings/"]').nth(5)
