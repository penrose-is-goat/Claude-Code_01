...
- Name: 02-filters.spec.ts >> pressing Apply straight after Reset does not re-apply the cleared filters
- Location: tests/e2e/02-filters.spec.ts:129:1
...
Call log:
  - waiting for getByRole('button', { name: 'Reset' })
