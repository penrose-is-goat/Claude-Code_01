...
- Name: 04-notes.spec.ts >> notes editor >> notes, rating, status and tags persist across reload
- Location: tests/e2e/04-notes.spec.ts:14:3
...
Call log:
  - waiting for locator('tbody tr a[href^="/listings/"]').nth(2)
