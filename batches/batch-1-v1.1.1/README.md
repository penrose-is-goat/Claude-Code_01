...
- Goal: stable live quote/history lookup, portfolio builder, compare, and backtest foundation

## Current Status

What Batch 1 v1.1 is meant to handle well:
