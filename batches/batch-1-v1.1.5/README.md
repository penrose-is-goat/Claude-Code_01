...
- Goal: stable live quote/history lookup plus populated ticker fundamentals with cache-first behavior for free-tier testing

## Current Status

What Batch 1 v1.1.5 is meant to handle well:
...
7. Footer shows `Batch 1 v1.1.5`

## v1.1.5 Fixes

- Added Alpha Vantage `OVERVIEW` as the fundamentals fallback for ticker analysis
- Mapped market cap, P/E, forward P/E, EPS, beta, yield, book value, shares outstanding, 52-week range, and moving averages into the UI and DB cache
- Fixed DB persistence for `dividend_rate` and `ex_dividend_date`
