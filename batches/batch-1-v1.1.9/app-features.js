  ...
  render(isCached=false) {
    ...
    const html = `
      ...
      <div style="color:var(--text-muted);font-size:0.78rem;margin:-8px 0 16px">
        Displayed price move uses provider quote fields. Beta card uses provider beta. Alpha, delta, gamma, and computed beta use trailing 1Y aligned against SPY.
      </div>
