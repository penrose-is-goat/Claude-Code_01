...
PA.API = {
  ...
  recordRequest(endpoint, params, requestUrl) {
  ...
  async fetchJson(endpoint, params={}) {
    ...
    const task = this.requestChain.then(async () => {
      ...
      try {
        ...
        this.recordRequest(endpoint, normalizedParams, requestUrl);
        ...
        throw this.recordError(error, { endpoint, params: normalizedParams, requestUrl });
      }
    });
