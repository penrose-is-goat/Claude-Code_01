    ...
    settingsGrid.insertAdjacentHTML('afterbegin', `
      <div class="card" id="td-settings-card">
        ...
        <div style="margin-top:10px;font-size:0.8rem;color:var(--text-muted)">
          Twelve Data powers live quotes/history. Alpha Vantage powers ticker fundamentals such as P/E, market cap, EPS, yield, and book value.
        </div>
        <div style="margin-top:8px;font-size:0.8rem;color:var(--text-muted)">
          Free keys are rate-limited. In Batch 1 v1.1.6, the app avoids a separate Twelve Data quote call when US markets are closed to conserve minute credits.
        </div>
