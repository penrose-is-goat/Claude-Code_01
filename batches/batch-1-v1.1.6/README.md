...
- `Batch 1 v1.1.6`
- Providers: `Twelve Data` for live quote/history and `Alpha Vantage` for fundamentals
- Goal: stable live quote/history lookup plus populated ticker fundamentals with lower Twelve Data minute burn for free-tier testing

## Current Status

What Batch 1 v1.1.6 is meant to handle well:

- Live ticker lookup
- Price charts across multiple ranges
- Ticker fundamentals such as P/E, forward P/E, market cap, EPS, beta, yield, moving averages, and shares outstanding
...
7. Footer shows `Batch 1 v1.1.6`

## v1.1.6 Fixes

- Reduced Twelve Data minute-credit usage by deriving the displayed quote from daily history when US markets are closed
- Preserved live Twelve Data quote calls for `Refresh Live` and for regular market hours
- Stored OHLC history in the local DB so the fallback quote can stay coherent across refreshes
