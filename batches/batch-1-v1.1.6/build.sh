    ...
    <div class="grid-2">
      ...
      <div class="card">
        ...
        <div style="color:var(--text-secondary);font-size:0.9rem;line-height:1.6">
          ...
          <p style="margin-top:8px"><strong>Data Sources:</strong> Twelve Data + Alpha Vantage fundamentals (Batch 1 v1.1.6)</p>
...
<footer class="status-bar">
  ...
  <div>Portfolio Analyzer Pro Batch 1 v1.1.6</div>
</footer>
