...
- Goal: stable live quote/history lookup, portfolio builder, compare, and backtest foundation with cache-first behavior for free-tier testing

## Current Status

What Batch 1 v1.1.2 is meant to handle well:
