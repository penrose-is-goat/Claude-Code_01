...
PA.Dashboard = {
  async init() {
    ...
    container.innerHTML = `
      <div style="padding:10px;color:var(--text-muted)">
        Market overview is manual in Batch 1 v1.1.1 to conserve Twelve Data credits.
  ...
  async loadMarketOverview() {
    ...
    try {
      ...
      container.innerHTML = '<div style="color:var(--text-muted);padding:10px">Unable to load live market overview right now.</div>';
    }
  },
