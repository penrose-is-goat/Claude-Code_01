...
class ModelRouterTests(unittest.TestCase):
    ...
    def test_macro_model_rejects_chart_and_time_language_at_boundary(self):
        with self.assertRaisesRegex(RuntimeError, "chart or time language"):
            model_router.macro_intent("gold price on opposite axis over the last 10 years")
