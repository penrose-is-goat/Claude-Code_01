...
PA.Ticker = {
  ...
  render(isCached=false) {
    ...
    const providerYtdReturn = q.ytdReturn ?? performance.ytdReturn ?? null;
    const providerOneYearReturn = q.oneYearReturn ?? performance.oneYearReturn ?? null;
    const providerThreeYearReturn = q.threeYearAverageReturn ?? performance.threeYearAverageReturn ?? null;
    const providerFiveYearReturn = q.fiveYearAverageReturn ?? performance.fiveYearAverageReturn ?? null;
