...
CSS=$(cat /home/user/Claude-Code_01/styles.css)
JS_CORE=$(cat /home/user/Claude-Code_01/app-core.js)
JS_CHARTS=$(cat /home/user/Claude-Code_01/app-charts.js)
JS_FEATURES=$(cat /home/user/Claude-Code_01/app-features.js)
JS_BACKTEST=$(cat /home/user/Claude-Code_01/app-backtest.js)
JS_MAIN=$(cat /home/user/Claude-Code_01/app-main.js)

cat > /home/user/Claude-Code_01/index.html << HTMLEOF
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
    ...
    <div class="grid-2">
      ...
      <div class="card">
        ...
        <div style="color:var(--text-secondary);font-size:0.9rem;line-height:1.6">
          ...
          <p style="margin-top:8px"><strong>Data Sources:</strong> Yahoo Finance API</p>
          <p><strong>Metrics:</strong> Beta, P/E, Forward P/E, Delta, Gamma, Alpha (Jensen's), Market Cap, Volume, Yield, Sharpe Ratio, Sortino Ratio, Max Drawdown, CAGR</p>
...
wc -l /home/user/Claude-Code_01/index.html
