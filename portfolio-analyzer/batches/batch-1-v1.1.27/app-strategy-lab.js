...
PA.StrategyLab = {
  ...
  inferEventMode(lower='') {
    if (/\b(?:federal funds|fed funds|fomc target|fed(?:eral)? funds rate)\b/.test(lower) && /\b(?:hike|hikes|hiked|increase|increases|increased|raise|raises|raised|cut|cuts|cutting|decrease|decreases|decreased|basis points?|bps?|bp)\b/.test(lower)) {
      return 'level-change';
    }
