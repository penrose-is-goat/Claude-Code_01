...
What Batch 1 v1.1.30.2 is meant to handle well:
...
```powershell
powershell -ExecutionPolicy Bypass -File .\start-v1.1.30.2.ps1
```
...
Batch 1 v1.1.30.2 uses a local market-data backend for:
...
7. Footer shows `Batch 1 v1.1.30.2`
