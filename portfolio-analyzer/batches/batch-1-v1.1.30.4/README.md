...
What Batch 1 v1.1.30.4 is meant to handle well:
...
```powershell
powershell -ExecutionPolicy Bypass -File .\start-v1.1.30.4.ps1
```
...
Batch 1 v1.1.30.4 uses a local market-data backend for:
...
7. Footer shows `Batch 1 v1.1.30.4`
