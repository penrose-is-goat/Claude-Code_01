        ...
        <div class="card">
          ...
          <div class="strategy-note">
            ${PA.UI.escapeHtml(config.eventMode === 'level-change'
              ? 'This chart centers on the latest signal window and shows the trigger rate change in basis points plus the normalized target price, so you can verify that the hike or cut really happened.'
