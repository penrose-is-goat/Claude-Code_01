    ...
    <div class="grid-2">
      ...
      <div class="card">
        ...
        <div style="color:var(--text-secondary);font-size:0.9rem;line-height:1.6">
          ...
          <p style="margin-top:8px"><strong>Data Sources:</strong> Local Python market-data backend (yfinance + Yahoo chart + FRED fallbacks, Batch 1 v1.1.30.1)</p>
...
<footer class="status-bar">
  ...
  <div>Portfolio Analyzer Pro Batch 1 v1.1.30.1</div>
</footer>
