    ...
    try {
      ...
      container.innerHTML = `
        <div class="market-dashboard-stack">
          ...
          <div>
            <div class="market-section-title">${this.drilldown || this.heatmapModes[this.heatmapMode]?.sourceTicker || this.heatmapModes[this.heatmapMode]?.sourceIndex ? 'Constituent List' : 'ETF Market List'}</div>
            ${listHtml}
          </div>
          <div>
